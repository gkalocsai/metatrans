...
public class SCheckProgressTest {
	...
	public void gen1() throws IOException, GrammarException{
    	...
    	Assert.assertNull(trr.getError());
	...
	public void exp1() throws GrammarException {
		...
		SyntaxTreePic pac=new SyntaxTreePic(sc.getTree());
	...
	public void current() throws GrammarException{
		...
		System.out.println(gh);
		new IndirectRecursionEliminator(gh.getIdCreator()).eliminate(gh.getGrammar(), gh.getRootGroup(), false);
